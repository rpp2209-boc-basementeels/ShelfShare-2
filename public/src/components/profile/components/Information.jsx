    ...
    return (
        <div>
            ...
            <div style={{"textAlign": "center", "position": "relative", "width": "30vw", "minWidth": "max-content"}}>
                ...
                <h4 style={{"marginTop": "2vh", "marginBottom": "0vh", "fontFamily": "Helvetica"}}>{props.info[0].first_name + " " + props.info[0].last_name}</h4>
                <h6 style={{"fontFamily": "Helvetica"}}>@{props.info[0].username}</h6>
                <hr></hr>
                <h3 style={{"marginTop": "5vh", "marginBottom": "5vh", "fontFamily": "Helvetica"}}>My Personal Information</h3>
                <h6 style={{"color": "GrayText", "fontFamily": "Helvetica"}}>Email Address: {props.info[0].email}</h6>
                <h6 style={{"color": "GrayText", "fontFamily": "Helvetica"}}>Age: {props.info[0].age}</h6>
                <h6 style={{"color": "GrayText", "fontFamily": "Helvetica"}}>Gender: {props.info[0].gender}</h6>
                <h6 style={{"color": "GrayText", "fontFamily": "Helvetica", "marginBottom": "5vh"}}>Address: 124 Conch St., Bikini Bottom, Earth 12345</h6>
